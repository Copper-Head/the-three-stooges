...
class NoResetSimpleRecurrent(SimpleRecurrent):
    ...
    @application(outputs=apply.outputs, inputs=apply.states)
    def initial_states(self, batch_size, *args, **kwargs):
        logger.info('INITIAL_STATES CALLED, brick='+str(self.name)+'; inputs='+ (str(kwargs.pop('inputs')) if 'inputs' in kwargs else ''))
